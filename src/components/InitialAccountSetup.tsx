...
export const InitialAccountSetup = ({
  ...
  return <div className="fixed inset-0 z-[200] bg-background/95 flex items-center justify-center p-4">
      <Card className="w-full max-w-lg border-border animate-fade-in">
        ...
        <CardContent className="space-y-6">
          ...
          {step === 1 && <div className="space-y-4 animate-fade-in">
            ...
            })} className="bg-background/50 border-border" autoFocus />
              </div>
            </div>}
          ...
          {step === 2 && <div className="space-y-4 animate-fade-in">
              <div className="space-y-4">
                ...
                <RadioGroup value={formData.accountType} onValueChange={value => setFormData({
              ...formData,
              accountType: value
            })} className="space-y-3">
                  <div className={`flex items-center space-x-3 border rounded-lg p-4 cursor-pointer transition-all ${formData.accountType === "artist" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"}`} onClick={() => setFormData({
                ...formData,
                accountType: "artist"
              })}>
                  ...
                  <div className={`flex items-center space-x-3 border rounded-lg p-4 cursor-pointer transition-all ${formData.accountType === "label" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"}`} onClick={() => setFormData({
                ...formData,
                accountType: "label"
              })}>
          ...
          {step === 3 && <div className="space-y-4 animate-fade-in">
              <div className="space-y-2">
                {formData.accountType === "artist" ? <>
                    ...
                    <Input id="artistName" placeholder="Your Artist Name" value={formData.artistName} onChange={e => setFormData({
                ...formData,
                artistName: e.target.value
                    ...
                    <Input id="labelName" placeholder="Your Label Name" value={formData.labelName} onChange={e => setFormData({
                ...formData,
          ...
          {step === 5 && <div className="space-y-4 animate-fade-in">
              ...
              <p className="text-sm text-muted-foreground">Save your card now for faster checkouts when distributing releases or requesting takedowns. You can verify your card below!</p>
